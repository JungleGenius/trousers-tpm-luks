...
pkgdatadir = $(datadir)/tpm-luks
pkgincludedir = $(includedir)/tpm-luks
pkglibdir = $(libdir)/tpm-luks
pkglibexecdir = $(libexecdir)/tpm-luks
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/tpm-luks.spec.in $(am__dist_plymouth_SCRIPTS_DIST) \
	$(dist_sbin_SCRIPTS) AUTHORS ChangeLog NEWS README TODO \
...
CONFIG_CLEAN_FILES = tpm-luks.spec
...
am__installdirs = "$(DESTDIR)$(confdir)" "$(DESTDIR)$(plymouthdir)" \
	"$(DESTDIR)$(sbindir)"
am__dist_plymouth_SCRIPTS_DIST =  \
	dracut/Fedora17/crypt-tpm/cryptroot-ask.sh \
	...
	dracut/RHEL7/crypt-tpm/cryptroot-ask.sh \
...
SCRIPTS = $(conf_SCRIPTS) $(dist_plymouth_SCRIPTS) \
	$(dist_sbin_SCRIPTS)
AM_V_P = $(am__v_P_$(V))
...
ACLOCAL = ${SHELL} /home/buildrpm/rpmsource/tpm-luks-0.8.0/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/buildrpm/rpmsource/tpm-luks-0.8.0/missing autoconf
AUTOHEADER = ${SHELL} /home/buildrpm/rpmsource/tpm-luks-0.8.0/missing autoheader
AUTOMAKE = ${SHELL} /home/buildrpm/rpmsource/tpm-luks-0.8.0/missing automake-1.13
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -W -Wall -Wno-unused-parameter -Wsign-compare
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"tpm-luks\" -DPACKAGE_TARNAME=\"tpm-luks\" -DPACKAGE_VERSION=\"0.8.0\" -DPACKAGE_STRING=\"tpm-luks\ 0.8.0\" -DPACKAGE_BUGREPORT=\"shpedoikal@gmail.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"tpm-luks\" -DVERSION=\"0.8.0\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\"
DEPDIR = .deps
DLLTOOL = false
DRACUT_KERNEL_MODULES = 
DRACUT_MODULE_NAME = crypt
DSYMUTIL = 
DUMPBIN = 
ECHO_C = 
ECHO_N = -n
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/buildrpm/rpmsource/tpm-luks-0.8.0/missing makeinfo
MANIFEST_TOOL = :
...
OTOOL64 = 
PACKAGE = tpm-luks
PACKAGE_BUGREPORT = shpedoikal@gmail.com
PACKAGE_NAME = tpm-luks
PACKAGE_STRING = tpm-luks 0.8.0
PACKAGE_TARNAME = tpm-luks
PACKAGE_URL = 
...
STRIP = strip
VERSION = 0.8.0
abs_builddir = /home/buildrpm/rpmsource/tpm-luks-0.8.0
abs_srcdir = /home/buildrpm/rpmsource/tpm-luks-0.8.0
abs_top_builddir = /home/buildrpm/rpmsource/tpm-luks-0.8.0
abs_top_srcdir = /home/buildrpm/rpmsource/tpm-luks-0.8.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/buildrpm/rpmsource/tpm-luks-0.8.0/install-sh
...
$(am__aclocal_m4_deps):
tpm-luks.spec: $(top_builddir)/config.status $(srcdir)/tpm-luks.spec.in
...
uninstall-confSCRIPTS:
	@$(NORMAL_UNINSTALL)
	@list='$(conf_SCRIPTS)'; test -n "$(confdir)" || exit 0; \
	files=`for p in $$list; do echo "$$p"; done | \
	       sed -e 's,.*/,,;$(transform)'`; \
	dir='$(DESTDIR)$(confdir)'; $(am__uninstall_files_from_dir)
install-dist_plymouthSCRIPTS: $(dist_plymouth_SCRIPTS)
	@$(NORMAL_INSTALL)
	@list='$(dist_plymouth_SCRIPTS)'; test -n "$(plymouthdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(plymouthdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(plymouthdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  if test -f "$$d$$p"; then echo "$$d$$p"; echo "$$p"; else :; fi; \
	...
	while read type dir files; do \
	     if test "$$dir" = .; then dir=; else dir=/$$dir; fi; \
	     test -z "$$files" || { \
	       echo " $(INSTALL_SCRIPT) $$files '$(DESTDIR)$(plymouthdir)$$dir'"; \
	       $(INSTALL_SCRIPT) $$files "$(DESTDIR)$(plymouthdir)$$dir" || exit $$?; \
	     } \
	; done

uninstall-dist_plymouthSCRIPTS:
	@$(NORMAL_UNINSTALL)
	@list='$(dist_plymouth_SCRIPTS)'; test -n "$(plymouthdir)" || exit 0; \
	files=`for p in $$list; do echo "$$p"; done | \
	       sed -e 's,.*/,,;$(transform)'`; \
	dir='$(DESTDIR)$(plymouthdir)'; $(am__uninstall_files_from_dir)
...
installdirs-am:
	for dir in "$(DESTDIR)$(confdir)" "$(DESTDIR)$(plymouthdir)" "$(DESTDIR)$(sbindir)"; do \
...
install-data-am: install-confSCRIPTS install-dist_plymouthSCRIPTS
...
uninstall-am: uninstall-confSCRIPTS uninstall-dist_plymouthSCRIPTS \
	uninstall-dist_sbinSCRIPTS
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	install install-am install-confSCRIPTS install-data \
	install-data-am install-dist_plymouthSCRIPTS \
	...
	uninstall-confSCRIPTS uninstall-dist_plymouthSCRIPTS \
	uninstall-dist_sbinSCRIPTS


yum/tpm-luks.action: yum/tpm-luks.action.in
	/usr/bin/sed -e s!\@sbindir\@!"${exec_prefix}/sbin"!g < $< > $@-t
	mv $@-t $@
